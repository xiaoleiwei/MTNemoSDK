...
Pod::Spec.new do |spec|
  ...
  spec.source_files  = "MTNemoSDK/MTNemoSDK.framework/Headers/*.{h}"
  spec.vendored_frameworks = 'MTNemoSDK/MTNemoSDK.framework'
  spec.public_header_files = 'MTNemoSDK/MTNemoSDK.framework/Headers/*.{h}'
